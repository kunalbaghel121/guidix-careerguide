...
// Clean professional template with photo for experienced professionals
...
const JobTemplate1WithPhoto = ({ resumeData }) => {
  const {
    personalInfo = {},
    experience = [],
    education = [],
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.photoSection}>
            <Image
              style={styles.photo}
              src={personalInfo.photo || '/api/placeholder/60/60'}
            />
          </View>
...
export default JobTemplate1WithPhoto;